...
Seralyth Template is a template used for developing custom plugins for Seralyth 1.0.0+. This plugin template is meant for plugin developers, if you don't know what you're doing stick to the plugin library.
